        ...
        <div className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-3">
            ...
            <FeatureCard
              ...
              description="Find shows quickly with a clean and simple discovery experience."
            />

            <FeatureCard
              icon={<Layers3 size={22} />}
              title="Explore collections"
              description="Browse through a beautiful collection of stories and characters."
            />

            <FeatureCard
              icon={<Compass size={22} />}
              title="Discover more"
              description="Dive into detailed information and find something unexpected."
            />
